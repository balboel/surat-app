...
<body>
    <div class="container">
        ...
        <div class="jenis">
            <h4 style="text-decoration: underline; font-weight:normal; margin-bottom:0">SURAT PENGANTAR SKCK
            </h4>
            <h4 style="margin-top:0; font-weight:normal">Nomor: 331/<?= $data['nomor_surat'] ?>
            </h4>
        </div>
    </div>
    <div class="content">
        ...
        <p style="text-indent:2.5em">Nama tersebut diatas adalah benar warga Desa Gemantar, Kecamatan Selogiri,
            Kabupaten Wonogiri. Berdasarkan catatan yang ada serta sepengetahuan kami dan iyanya :</p>
        <a>1.&nbsp;&nbsp;Berkelakuan baik, tidak pernah melakukan tindakan/perbuatan yang menyimpang atau norma sosial
            yang
            berlaku</a><br>
        <a>2.&nbsp;&nbsp;Tidak bersangkut paut perkara kriminal</a><br>
        <a>3.&nbsp;&nbsp;Tidak dalam status tahanan berwajib</a><br>
        <a>4.&nbsp;&nbsp;Tidak terlibat dalam penggunaan Narkoba</a><br>
