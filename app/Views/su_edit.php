...
<body>
    ...
    <main>
        <section>
            <form action="/surat/updateSu" method="post">
                <label for="nomor_surat">Nomor Surat:</label>
                <input type="text" id="nomor_surat" name="nomor_surat" value="<?= $su['nomor_surat'] ?>">

                <label for="pj_id">Penanggung Jawab:</label>
                <select id="pj_id" name="pj_id">
                    <?php foreach ($penanggung_jawab as $pj): ?>
                        <option value="<?= $pj['id'] ?>" <?= $pj['id'] == $su['pj_id'] ? 'selected' : '' ?>><?= $pj['nama'] ?>
                            -
                            <?= $pj['jabatan'] ?>
                        </option>
                    <?php endforeach; ?>
                ...
                <input type="date" id="hari_tanggal" name="hari_tanggal" value="<?= $su['hari_tanggal'] ?>">

                <label for="waktu_dari">Waktu:</label>
                <input type="time" id="waktu_dari" name="waktu_dari" value="<?= $su['waktu_dari'] ?>">WIB s/d <input
                    type="time" id="waktu_ke" name="waktu_ke">Selesai apabila kosong

                <label for="tempat_undangan">Tempat:</label>
                <input type="text" id="tempat_undangan" name="tempat_undangan" value="<?= $su['tempat_undangan'] ?>">

                <label for="keperluan">Keperluan:</label>
                <textarea id="keperluan" name="keperluan" value="<?= $su['keperluan'] ?>"></textarea>
