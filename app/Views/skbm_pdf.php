...
<body>
    <div class="container">
        ...
        <div class="jenis">
            <h4 style="text-decoration: underline; font-weight:normal; margin-bottom:0">SURAT KETERANGAN BELUM MENIKAH
            </h4>
    ...
    <div class="content">
        ...
        <p>Adalah Penduduk Desa Gemantar dan Benar-benar belum menikah.</p>
        <p>Demikian surat keterangan ini kami buat, untuk <?= $data['keperluan'] ?></p>
    </div>
    <div class="footer">
        <?php
