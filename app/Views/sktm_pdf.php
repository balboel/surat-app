...
<body>
    <div class="container">
        ...
        <div class="jenis">
            <h4 style="text-decoration: underline; font-weight:normal; margin-bottom:0">SURAT KETERANGAN TIDAK MAMPU
            </h4>
            <h4 style="margin-top:0; font-weight:normal">Nomor: 410/<?= $data['nomor_surat'] ?>
            </h4>
        </div>
    </div>
    <div class="content">
        ...
        <p style="text-indent:2.5em">Nama tersebut diatas adalah benar warga Desa Gemantar, Kecamatan Selogiri,
            ...
            keterangan yang ada pada kami benar bahwa yang bersangkutan tergolong keluarga tidak mampu. Surat Keterangan
            ini dibuat untuk <?= $data['keperluan'] ?>.</p>
